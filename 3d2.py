...
while running:
    ...
    line1 = pg.draw.line(screen, (255,255,255), (d1pa[0] * 200 + WIDTH / 2, d1pa[1] * 200 + HEIGHT / 2), (d2pa[0] * 200 + WIDTH / 2, d2pa[1] * 200 + HEIGHT / 2))
    line1 = pg.draw.line(screen, (255,255,255), (d2pa[0] * 200 + WIDTH / 2, d2pa[1] * 200 + HEIGHT / 2), (d3pa[0] * 200 + WIDTH / 2, d3pa[1] * 200 + HEIGHT / 2))
    print(d1pa)
